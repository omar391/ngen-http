...
public class UserAgentSwitcher {
    ...
    static {
        //Get more from: http://useragentstring.com/pages/useragentstring.php
        ...
        uaMap.put("Firefox", new String[]{
                ...
                "Mozilla/5.0 (Macintosh; U; Intel Mac OS X; en-US; rv:1.8.1.13) Gecko/20080313 Firefox","Mozilla/5.0 (X11; Linux i686; rv:64.0) Gecko/20100101 Firefox/64.0",

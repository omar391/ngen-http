...
public class UserAgentSwitcherOld {
    ...
    private List<String> getChromeUA() {
        //Update:http://useragentstring.com/pages/useragentstring.php?name=Chrome
    ...
    private List<String> getFireFoxUA() {
        //Update:http://useragentstring.com/pages/useragentstring.php?name=Firefox
